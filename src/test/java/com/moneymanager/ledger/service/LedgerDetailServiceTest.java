 ...
 * 파일이름       : LedgerDetailServiceTest<br>
 * 작성자          : areum Jang<br>
 * 생성날짜       : 25. 12. 8<br>
...
public class LedgerDetailServiceTest {
	...
	void 카테고리검색이면_선택한_날짜로_내역조회(){
		...
		when(ledgerDao.findLedgersBySearch("member123", search.getMode(), search.getKeywords(), mockPeriod))
				.thenReturn(mockDao);
