...
public class LedgerValidatorTest {
	...
	class RegisterTest {
		...
		class Success {
			...
			void validatesLedgerRegister_whenRequestHasNoImage(String description, LedgerWriteRequest request){
				//when & then
			...
			void validatesLedgerRegister_whenMemoIsWithin150Chars(String memo){
				//given
			...
			void validatesLedgerRegister_whenAddressIsValid(String description, LedgerWriteRequest request) {
				//when & then
				assertThatCode(() -> ledgerValidator.register(request))
						.doesNotThrowAnyException();
			}
		...
		class Failure {
			...
			void throwsException_whenRequestIsNull(LedgerWriteRequest request){
				//when
			...
			void throwsException_whenDateIsInvalid(String description, String value, ErrorCode errorCode, String[] userMsg, String[] logMsg) {
				//given
				LedgerWriteRequest request =
						defaultLedgerWriteRequest()
								.date(value)
			...
			void throwsException_whenCategoryIsInvalid(String description, String value, ErrorCode errorCode, String[] userMsg, String[] logMsg) {
				//given
				LedgerWriteRequest request =
						defaultLedgerWriteRequest()
								.categoryCode(value)
			...
			void throwsException_whenAmountIsNull(Long value) {
				//given
				LedgerWriteRequest request =
						defaultLedgerWriteRequest()
								.amount(value)
			...
			void throwsException_whenAmountTypeIsInvalid(String description, String value, ErrorCode errorCode, String[] userMsg, String[] logMsg) {
				//given
				LedgerWriteRequest request =
						defaultLedgerWriteRequest()
								.amountType(value)
			...
			void throwsException_whenAmountFixCycleIsInvalid(String cycle){
				//given
				LedgerWriteRequest request =
						defaultLedgerWriteRequest()
								.fixed(true)
			...
			void throwsException_whenMemoExceeds150Chars(String memo){
				//given
				LedgerWriteRequest request =
						defaultLedgerWriteRequest()
								.memo(memo)
			...
			void throwsException_whenPlaceIsInvalid(String description, LedgerWriteRequest request, ErrorCode errorCode, String[] userMsg, String[] logMsg){
				//when
				Throwable throwable = catchThrowable(() -> ledgerValidator.register(request));
