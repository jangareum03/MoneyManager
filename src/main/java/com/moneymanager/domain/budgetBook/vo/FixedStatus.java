...
/**
 * <p>
 * 패키지이름    : com.moneymanager.domain.budgetBook.vo<br>
 * 파일이름       : FixedStatus<br>
 * 작성자          : areum Jang<br>
 * 생성날짜       : 25. 11. 24.<br>
...
public class FixedStatus {
	...
	public FixedStatus(boolean fixed, FixedPeriod period) {
		if( fixed && period == null ) {
			throw createClientException(ErrorCode.BUDGET_FIX_MISSING, "고정 주기는 필수입니다.");
		}

		if( !fixed && period != null ) {
			throw createClientException(ErrorCode.BUDGET_FIX_INVALID, "고정 여부를 확인해주세요.", period);
		}
