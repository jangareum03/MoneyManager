 ...
 * 파일이름       : SignupApiController<br>
 * 작성자          : areum Jang<br>
 * 생성날짜       : 26. 9. 21<br>
 * 설명              : 회원가입 관련 요청을 처리하는 클래스
 * </p>
 * <br>
...
public class SignupApiController {
    ...
    public ApiBody<Void> sendCode(@RequestBody SendVerificationCodeRequest request){
        signupService.validateDuplicationEmail(request.email());
    ...
    public ApiBody<String> verifyEmail(@RequestBody EmailVerifyRequest request, HttpServletResponse response) {
        String token = signupService.confirmEmail(request.email(), request.code());
