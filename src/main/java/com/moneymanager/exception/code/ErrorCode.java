...
import com.moneymanager.enums.SystemMessage;
...
public enum ErrorCode {
	 ...
	 * 로그인 에러메시지
	 **/
	LOGIN_ID_MISSING("C010101", "아이디를 입력해주세요.", "아이디 미입력"),
	LOGIN_ID_FORMAT("C010102", "아이디는 4~15자 사이의 영어와 숫자만 입력 가능합니다.", "아이디 형식 불일치"),
	LOGIN_ID_NONE("C010104", "아이디 또는 비밀번호를 확인해주세요.", "미가입한 아이디"),
	LOGIN_PASSWORD_MISSING("C010201", "비밀번호를 입력해주세요.", "비밀번호 미입력"),
	LOGIN_PASSWORD_FORMAT("C010202", "비밀번호는 8~20자 사이의 영어,숫자,특수문자(!%#^*)만 입력 가능합니다.", "비밀번호 형식 불일치"),
	LOGIN_ACCOUNT_MISMATCH("C010004", "아이디 또는 비밀번호를 확인해주세요.", "아이디와 비밀번호 불일치 "),
	LOGIN_ACCOUNT_UNAUTHORIZED_RESTORE("C010007", "해당 계정은 탈퇴된 상태로 로그인이 불가능합니다. 가입하실 때 입력하신 이메일로 임시 비밀번호를 보내드렸으니, 다시 한 번 로그인 부탁드립니다.", "복구 가능한 계정으로 로그인 시도"),
	LOGIN_ACCOUNT_UNAUTHORIZED_RESIGN("C010007", "회원가입 하지 않는 아이디입니다. 회원가입을 진행해 주세요.", "복구 불가능한 계정으로 로그인 시도"),
	LOGIN_ACCOUNT_UNAUTHORIZED_LOCKED("C010007", "로그인 횟수를 초과로 로그인 할 수 없는 상태입니다. 가입하신 이메일로 임시 비밀번호를 보내드렸으니, 다시 한 번 로그인 부탁드립니다.", "잠긴 계정으로 로그인 시도"),
	LOGIN_SECURITY_AUTHORIZATION_ACCESS_DENIED("S050202", "", "알 수 없는 사용자 상태로 서비스 접근 불가"),
	/**
	 * 회원가입 에러메시지
	 **/
