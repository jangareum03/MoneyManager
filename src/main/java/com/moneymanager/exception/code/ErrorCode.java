...
public enum ErrorCode {
	 ...
	 * 로그인 에러메시지
	 **/
	LOGIN_ID_MISSING("C010101", "아이디를 입력해주세요.", "사용자 로그인 중 아이디 미입력"),
	LOGIN_ID_FORMAT("C010102", "아이디는 4~15자 사이의 영어와 숫자만 입력 가능합니다.", "사용자 로그인 중 아이디 형식 불일치"),
	LOGIN_PASSWORD_MISSING("C010201", "비밀번호를 입력해주세요.", "사용자 로그인 중 비밀번호 미입력"),
	LOGIN_PASSWORD_FORMAT("C010202", "비밀번호는 8~20자 사이의 영어,숫자,특수문자(!%#^*)만 입력 가능합니다.", "사용자 로그인 중 비밀번호 형식 불일치"),
	LOGIN_ACCOUNT_MISMATCH("C010004", "아이디 또는 비밀번호가 일치하지 않습니다.", "미가입한 계정으로 로그인 시도"),
