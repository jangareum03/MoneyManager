package com.moneymanager.global.domain.enums;
...
public enum RegexPattern {
	 ...
	 * 주소 관련된 정규식 패턴 모음
	 * <ul>
	 *     <li>장소명(ADDRESS_PLACE_NAME) : 한글, 영문, 숫자, 공백, 괄호, 하이픈, 점만 입력 가능</li>
	 *     <li>도로명(ADDRESS_ROAD_NAME) : 한글, 영문, 숫자, 공백, 하이픈만 입력 가능</li>
	...
	* </ul>
	*/
	MEMBER_USERNAME("^[a-zA-Z][a-zA-Z0-9]{3,14}$"),
