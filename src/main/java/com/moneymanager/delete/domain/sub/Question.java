package com.moneymanager.delete.domain.sub;
 ...
 *  * 작성자          : areum Jang<br>
 *  * 생성날짜       : 23. 2. 11<br>
 *  * 설명              : TB_QA_QUESTION 테이블과 매칭되는 클래스
 * </p>
 * <br>
...
public class Question {
    private Long id;										//질문번호(식별자)
    private String title;								//제목
    private String content;							//내용
    private Character open;						//공개여부
    private Character answer;						//답변여부
